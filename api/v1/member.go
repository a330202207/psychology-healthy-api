...
type MemberEditReq struct {
	g.Meta     `path:"/member/add" method:"post" tag:"memberService" summary:"添加管理员" tags:"管理员管理"`
	ID         int64   `json:"id"`
...
type MemberUpdatePassWdReq struct {
	g.Meta `path:"/member/updatePassWd" method:"post" tag:"memberService" summary:"修改密码" tags:"修改密码"`
	ID     int64  `json:"id"`
	Passwd string `json:"passwd" v:"required|length:4,20#密码不能为空|密码长度应当在4到20之间" dc:"密码"`
}
...
type MemberResetPassWdReq struct {
	g.Meta     `path:"/member/resetPassWd" method:"post" tag:"memberService" summary:"重置密码" tags:"重置密码"`
...
type MemberDelReq struct {
	g.Meta `path:"/member/del" method:"post" tag:"memberService" summary:"删除管理员" tags:"删除管理员"`
...
type MemberListReq struct {
	g.Meta   `path:"/member/list" method:"get" tag:"memberService" summary:"管理员列表" tags:"管理员列表"`
...
type MemberGetReq struct {
	g.Meta `path:"/member/get" method:"get" tag:"memberService" summary:"获取管理员信息" tags:"获取管理员信息"`
	ID     int64 `v:"required#管理员ID不能为空" json:"id"`
}
