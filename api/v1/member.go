...
type MemberUpdatePassWdReq struct {
	g.Meta `path:"/member/updatePassWd" method:"post" summary:"修改密码" tags:"管理员管理"`
	ID     int64  `json:"id"`
	Passwd string `json:"passwd" v:"required|length:4,20#密码不能为空|密码长度应当在4到20之间" dc:"密码"`
}
...
type MemberResetPassWdReq struct {
	g.Meta     `path:"/member/resetPassWd" method:"post" summary:"重置密码" tags:"管理员管理"`
...
type MemberDelReq struct {
	g.Meta `path:"/member/del" method:"post" summary:"删除管理员" tags:"管理员管理"`
...
type MemberListReq struct {
	g.Meta   `path:"/member/list" method:"get" summary:"管理员列表" tags:"管理员管理"`
...
type MemberGetReq struct {
	g.Meta `path:"/member/get" method:"get" summary:"获取管理员信息" tags:"管理员管理" `
	ID     int64 `v:"required#管理员ID不能为空" json:"id"`
}
